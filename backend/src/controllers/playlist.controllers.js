...
const createPlayList = async(req, res, next) => {
    ...
    try {
        ...
        res.status(200).json(
            new ApiSuccess(200, "Playlist created", playlist) 
        )
    } catch (error) {
...
const getAllListDetails = async (req, res, next) => {
    try {
        ...
        res.status(200).json(
            new ApiSuccess(200, "Playlists fetched successfully", playlists) 
        )
    } catch (error) {
...
const addProblemToPlaylist = async (req, res, next) => {
    ...
    try {
        ...
        res.status(201).json(
            new ApiSuccess(201, "problem added to playlist successfully", problemsInPlaylist) 
        )
    } catch (error) {
...
const removeProblemFromPlaylist = async (req, res, next) => {
    ...
    try {
        ...
        res.status(200).json(
            new ApiSuccess(200, "problem deleted from playlist successfully", deletePlayList) 
        )
    } catch (error) {
