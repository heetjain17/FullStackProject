...
const getAllSubmissionForProblem = async (req, res, next) => {
    ...
    try {
        ...
        res.status(200).json(
            new ApiSuccess(200, "Submissions fetched by id", submission)
        )
    } catch (error) {
...
const getAllTheSubmissionsForProblem = async (req, res, next) => {
    ...
    try {
        ...
        res.status(200).json(
            new ApiSuccess(200, "All Submission fetched by id", count)
        )
    } catch (error) {
...
export {getAllSubmissions, getAllSubmissionForProblem, getAllTheSubmissionsForProblem}
